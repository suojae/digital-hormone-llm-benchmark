...
\caption{Tri-axis digital hormone controller overview. Heterogeneous signals are compressed into $(d_t, c_t, e_t)$ and mapped to prompt, decoding, tool, and budget controls.}
